...
$fielddef = array(
    'f0' => array(FLD_ID => true, FLD_VISIBLE => false, FLD_DISPLAY => '', FLD_DISPLAY_SZ => 7,
        ...
        FLD_DATABASE => 'IdEml'),
// JClark 2014-12-10 Remove FLD_INPUT_VAIDATION for this field - starting to create errors.. for no value..?
//  'f1' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Eml_address', FLD_DISPLAY_SZ => 100,
//      FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
//      FLD_INPUT_SZ => 100, FLD_INPUT_MAXLEN => 181, FLD_INPUT_DFLT => '',
//      FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => 'EMail',
//      FLD_DATABASE => 'Eml_address')
    'f1' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Eml_address', FLD_DISPLAY_SZ => 100,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 100, FLD_INPUT_MAXLEN => 181, FLD_INPUT_DFLT => '',
...
switch ($mode) {
    case 's':
        ...
        $rows = dbu_handle_select($fielddef, $scheme, $table, $dbconn, $keys, $start, $config['rows_per_page'], $config['pager_items'], $pager, 'Eml_address');

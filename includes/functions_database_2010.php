<?php
    ...
    // Purpose:  Create a new dtabase from scratch - deleting the database first if it is there
    // Parameters:
    ...
    function initializeDatabase($host, $database, $schema, $admin, $adminPassword){
        ...
        //      CONSTRAINT fk_Race_Heat_Header
        //      FOREIGN KEY (idHeat_Header )
        //      REFERENCES heat_header (idHeat_Header )
        //      ON DELETE NO ACTION
        //      ON UPDATE NO ACTION,

        //     CONSTRAINT fk_idRacer1
        //     FOREIGN KEY (idRacer1)
        //     REFERENCES racer (idRacer)
        //     ON DELETE NO ACTION
        //     ON UPDATE NO ACTION,

        //      CONSTRAINT fk_idRacer2
        //      FOREIGN KEY (idRacer2)
        //      REFERENCES racer (idRacer)
        //      ON DELETE NO ACTION
        //      ON UPDATE NO ACTION,

        //      CONSTRAINT fk_idRacer3
        //      FOREIGN KEY (idRacer3)
        //      REFERENCES racer (idRacer)
        //      ON DELETE NO ACTION
        //      ON UPDATE NO ACTION);";
        ...
        // Create indexes over "race" table
        //        $sql = "CREATE UNIQUE INDEX fk_race_heat_header ON ". $schema .".race (idHeat_Header ASC) ;";
        //        $result = $dbconn->db_query($sql);
        //       if (!$result) {
        //           echo "Index fk_race_heat_header not created </br>"; 
        //            return $result;  
        //       } else {
        //           echo "&#134   Index fk_race_heat_header created </br>"; 
        //        }
        ...
        // Create indexes over "heat" table
        //        $sql = "CREATE UNIQUE INDEX by_heat ON ". $schema .".heat (Heat_Header_idHeat_Header ASC, Number ASC);";
        //        $result = $dbconn->db_query($sql);
        //        if (!$result) {
        //            echo "Index by_heat not created </br>"; 
        //            return $result;  
        //        } else {
        //            echo "&#134   Index by_heat created </br>"; 
        //        }

        //        $sql = "CREATE UNIQUE INDEX fk_heat_heat_header ON ". $schema .".heat (`heat_header_idHeat_header` ASC);";
        //        $result = $dbconn->db_query($sql);
        //        if (!$result) {
        //            echo "Index fk_heat_heat_header not created </br>"; 
        //            return $result;  
        //        } else {
        //            echo "&#134   Index fk_heat_heat_header created </br>"; 
        //        }
    ...
    function pack55Inserts2009($host, $database, $schema, $admin, $adminPassword){
        ...
        // Add den 1 racers
        $sql = "INSERT INTO den values(0, 1, 'Tiger Den 1 (Stamoulis)', 'Mrs. Stamoulis', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id();
        $sql = "INSERT INTO racer values(0, 'Colin', 'Wing', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Connor', 'Howley', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Thomas', 'Hayes', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'Adriaansen', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jason', 'Wang', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'James', 'Stamoulis', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      


        // Add den 2 racers 
        $sql = "INSERT INTO den values(0, 2, 'Bear Den 2 (Howe)', 'Mr. Howe', 'Bear', 3)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Dominic', 'Gianetto', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Adam', 'Hamling', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jason', 'Howe', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jonathon', 'Symons', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Isaac', 'Theriault', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jake', 'Bure', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Owen', 'Coderre', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Matthew', 'Jennings', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Federici', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Amir', 'Baghen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jake', 'Hathaway', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 3 racers 
        $sql = "INSERT INTO den values(0, 3, 'Tiger Den 3 (Henriques)', 'Mrs. Henriques', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Alex', 'Henriques', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Foster', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Ryan', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jack', 'Herold', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Lin', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Taylor', 'Armstrong', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Josha', 'Moses', $denNumber)";
        $result = $dbconn->db_query($sql);


        // Add den 4 racers 
        $sql = "INSERT INTO den values(0, 4, 'Webelos Den 4 (Laman)', 'Mr. Laman', 'Webelos II', 5)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Tyler', 'Blight', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Charles', 'Chen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Bill', 'Knapp', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ben', 'Laman', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Cory', 'Champeon', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'McGlynn', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Sean', 'McKenna', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 5 racers   
        $sql = "INSERT INTO den values(0, 5, 'Webelos Den 5 (Robbins)', 'Mr. Robbins', 'Webelos I', 4)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 

        $sql = "INSERT INTO racer values(0, 'Zachary', 'Carter', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Travis', 'Jobes', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Polhemus', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Christopher', 'Perry', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Robbins', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Patrick', 'Robbins', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Nicholas', 'Warren', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Adam', 'Dolce', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Gabriel', 'Prepetit', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 6 racers  
        $sql = "INSERT INTO den values(0, 6, 'Webelos Den 6 (Youssef)', 'Mrs. Youssef', 'Webelos II', 5)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'PJ', 'Greenwood', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Curtis', 'Clark', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Dan', 'Crescitelli', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Johnny', 'Robbins', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Zachary', 'Skowronek', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Zachary', 'Youssef', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 7 racers 
        $sql = "INSERT INTO den values(0, 7, 'Wolf Den 7 (MacNeil)', 'Mrs. MacNeil', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Jacob', 'Cashin', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jack', 'Hanna', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Benjamin', 'MacNeil', $denNumber)";
        $result = $dbconn->db_query($sql);   
        $sql = "INSERT INTO racer values(0, 'Nicholas', 'Manning', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Derrick', 'Nolan', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jack', 'Ouano', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Alexander', 'Henroz', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Chen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ben', 'Newman', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Matthew', 'Webster', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Preston', 'Green', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 8 racers 
        $sql = "INSERT INTO den values(0, 8, 'Wolf Den 8 (Collins)', 'Mr. Collins', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'William', 'Collins', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Liam', 'Tsen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Samuel', 'Robert', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Dylan', 'OReilly', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 9 racers   
        $sql = "INSERT INTO den values(0, 9, 'Wolf Den 9 (Kearney)', 'Mr. Kearney', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Adam', 'Costello', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Joseph', 'Kearney', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'MacGilvray', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Sam', 'Slovin', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Kevin', 'Tucker', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Derek', 'Blanchard', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Adam', 'Davison', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Rishav', 'Sarma', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Lukas', 'Warner', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 10 racers   
        $sql = "INSERT INTO den values(0, 10, 'Bear Den 10 (Richardson)', 'Mrs. Richardson', 'Bear', 3)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Ben', 'MacGilivray', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Blight', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Zachary', 'Hopfmann', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jonathan', 'Moses', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Zachary', 'Provencal', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Louis', 'Stamoulis', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Joseph', 'Melisi', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 11 racers 
        $sql = "INSERT INTO den values(0, 11, 'Tiger Den 11 (Dupont)', 'Mr. Dupont', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);  
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Ilyas', 'DuPont', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Spencer', 'Devine', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Hayden', 'Rosenberg', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Adian', 'McKenna', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Noah', 'Long', $denNumber)";
        $result = $dbconn->db_query($sql);   
        $sql = "INSERT INTO racer values(0, 'Cullen', 'Walsh', $denNumber)";
        $result = $dbconn->db_query($sql);

        $sql = "INSERT INTO den values(0, 12, 'Siblings', '', 'Sibling', 6)";
        $result = $dbconn->db_query($sql);  
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Carleigh', 'Rosenberg', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Kerri', 'Walsh', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Mark', 'Stamoulis', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Justin', 'Wang', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Christian', 'Adriaansen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Grace', 'Coderre', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Kathryn', 'Howe', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Julia', 'Howe', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Maeve', 'Hamling', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Jennings', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jessica', 'Henriques', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Kate', 'Foster', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Josh', 'Foster', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Mary', 'Youssef', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Sabrina', 'Greenwood', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Matthew', 'MacNeil', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Marie-Axelle', 'Henroz', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Amaury', 'Henroz', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Alley', 'Cashin', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Max', 'Hanna', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'William', 'Manning', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Edward', 'Collins', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Davison', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Haley', 'Costello', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ashley', 'Costello', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Marcus', 'Blanchard', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Caitlyn', 'Blanchard', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Megan', 'Tucker', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jonathan', 'Melisi', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Justin', 'MacGillivray', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ethan', 'MacGillivray', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Zach', 'Dupont', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        $result = $dbconn->db_query($sql);  
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'John', 'Clark', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Tim', 'Howe', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Steve', 'Adriaansen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Doug', 'Tucker', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add email addresses to get started (jclark@atonbllc.com already added)
        $sql = "INSERT INTO valid_emails values(0, 'aldo@gtekllc.com')";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO valid_emails values(0, 'tlhowe@charter.net')";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO valid_emails values(0, 'lamanj@verizon.net')";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO valid_emails values(0, 'dougjt@yahoo.com')";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO valid_emails values(0, 'johnlclark3@yahoo.com')";
        $result = $dbconn->db_query($sql);

...
//      $dbconn->db_connect_only($host, $admin, $adminPassword);
        ...
        // Add den 1 racers
        $sql = "INSERT INTO den values(0, 1, 'Webelos Den 1 (Hays)', 'Mrs. Hays', 'Webelos I', 4)";
        $result = $dbconn->db_query($sql);
        ...
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Jake', 'Clancy', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Connor', 'Howley', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Leo', 'Maggiolino', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Philip', 'Ricciuti', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      


        // Add den 2 racers 
        $sql = "INSERT INTO den values(0, 2, 'Tiger Den 1 (Roberts)', 'Mrs. Roberts', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'Cashel', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Vincent', 'Orrino', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 3 racers 
        $sql = "INSERT INTO den values(0, 3, 'Webelos I Den 3 (Henriques)', 'Mrs. Henriques', 'Webelos I, 4)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'Monahan', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 5 racers 
        $sql = "INSERT INTO den values(0, 5, 'Wolf Den 5 (Nascimento)', 'Mr. Nascimento', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Matthew', 'MacNeil', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'James', 'Ares', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Mark', 'Cayer', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ian', 'Donovan', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Grandpre', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ahmed', 'Hoosen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Cameron', 'Kane', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Alexander', 'Nascimento', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Marcus', 'Reeve-Patel', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Kieran', 'Reeve-Patel', $denNumber)";
        $result = $dbconn->db_query($sql);
         $sql = "INSERT INTO racer values(0, 'Ethan', 'Chang', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Noah', 'Berk', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Gennaro', 'Orrino', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 6 racers  
        $sql = "INSERT INTO den values(0, 6, 'Bear Den 6 (Hetherington)', 'Mrs. Hetherington', 'Bear', 3)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Nicholas', 'Barrette', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Benjamin', 'Davidson', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Divitto', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Aiden', 'Richardson', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jacob', 'Zhang', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Tyler', 'Clancy', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Brogan', 'Madden', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Christopher', 'Chun', $denNumber)";
        $result = $dbconn->db_query($sql);


        // Add den 7 racers 
        $sql = "INSERT INTO den values(0, 7, 'Webelos II Den 7 (Nolan)', 'Mrs. Nolan', 'Webelos II', 5)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Derick', 'Nolan', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 8 racers 
        $sql = "INSERT INTO den values(0, 8, 'Wolf Den 8 (Colebraun)', 'M. Colebraun', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Christian', 'Adriaansen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Kyle', 'Colebraun', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'John', 'Kurina', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Alexander', 'Reineke', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Arnav', 'Thube', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Yusuf', 'Ali', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Harrison', 'Stanwood', $denNumber)";
        $result = $dbconn->db_query($sql);
        
        // Add den 9 racers   
        $sql = "INSERT INTO den values(0, 9, 'Webelos II Den 9 (Tucker)', 'Mr. Tucker', 'Webelos II', 5)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'MacGillivray', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 10 racers   
        $sql = "INSERT INTO den values(0, 10, 'Tiger Den 10 (Jorgensen)', 'M. Jorgensen', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Dylan', 'Clancy', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Mustafa', 'Ahmed', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Eiben', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Dillon', 'Richardson', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Joshua', 'Colebraun', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Landen', 'Jorgensen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'John', 'Feeney', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Thomas', 'Rabideau', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Harrison', 'Prohaska', $denNumber)";
        $result = $dbconn->db_query($sql);

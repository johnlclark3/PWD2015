<?php
    ...
    function pack55Inserts2011($host, $database, $schema, $admin, $adminPassword){
        ...
        // Add den 1 racers
        $sql = "INSERT INTO den values(0, 1, 'Wolf Den 1 (Stamoulis)', 'Mrs. Hays', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id();
        $sql = "INSERT INTO racer values(0, 'Colin', 'Wing', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Uzar', 'Nicholas', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Thomas', 'Hayes', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'Adriaansen', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Bryan', 'Dawson', ".$denNumber.")";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'James', 'Stamoulis', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Kyle', 'Walker', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Joesph', 'Pulsifer', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      
        $sql = "INSERT INTO racer values(0, 'Jske', 'Clancy', ".$denNumber.")";
        $result = $dbconn->db_query($sql);      


        // Add den 2 racers 
        $sql = "INSERT INTO den values(0, 2, 'Webelos Den 2 (Howe)', 'Mr. Howe', 'Webelos I', 4)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        // Add den 3 racers 
        $sql = "INSERT INTO den values(0, 3, 'Wolf Den 3 (Henriques)', 'Mrs. Henriques', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'Garvey', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 4 racers 
        $sql = "INSERT INTO den values(0, 4, 'Tiger Den 4 (Borden)', 'Mr. Borden', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Jack', 'Borden', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Brendan', 'Caterino', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Edward', 'Collins', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Marc', 'Davidson', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Maxwell', 'Hanna', $denNumber)";
        $result = $dbconn->db_query($sql);   
        $sql = "INSERT INTO racer values(0, 'Andrew', 'Lee', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jonathan', 'Melisi', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Michael', 'Perry', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Joseph', 'Scangas', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 5 racers   
        $sql = "INSERT INTO den values(0, 5, 'Webelos Den 5 (Robbins)', 'Mr. Robbins', 'Webelos II', 5)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Benjamin', 'Guerriero', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Gabriel', 'Prepetit', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 6 racers  
        $sql = "INSERT INTO den values(0, 6, 'Tiger Den 6 (Hetherinton)', 'Mrs. Hetherinton', 'Tiger', 1)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Nicholas', 'Barrette', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Benjamin', 'Davison', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Joshua', 'Drake', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Owen', 'Garron', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Sean', 'Leahy', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jack', 'Quinlan', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Brian', 'Rabideau', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Daivitto', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Aiden', 'Richardson', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Jakob', 'Zhang', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 7 racers 
        $sql = "INSERT INTO den values(0, 7, 'Wolf Den 7 (MacNeil)', 'Mrs. MacNeil', 'Bear', 3)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);   
        $sql = "INSERT INTO racer values(0, 'Harley', 'Babeu', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 9 racers   
        $sql = "INSERT INTO den values(0, 9, 'Bear Den 9 (Kearney)', 'Mr. Kearney', 'Bear', 3)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Colin', 'Jorgensen', $denNumber)";
        $result = $dbconn->db_query($sql);

        // Add den 10 racers   
        $sql = "INSERT INTO den values(0, 10, 'Webelos Den 10 (Richardson)', 'Mrs. Richardson', 'Webelos I', 4)";
        $result = $dbconn->db_query($sql);
        $denNumber = mysql_insert_id(); 
        $sql = "INSERT INTO racer values(0, 'Ben', 'MacGilivray', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'John', 'Cashel', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        // Add den 11 racers 
        $sql = "INSERT INTO den values(0, 11, 'Wolf Den 11 (Walsh)', 'Mr. Walsh', 'Wolf', 2)";
        $result = $dbconn->db_query($sql);  
        $denNumber = mysql_insert_id(); 
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Phiip', 'Ricciuti', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ally', 'Cashin', $denNumber)";
        $result = $dbconn->db_query($sql);
        ...
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Matthew', 'Uzar', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Gianna', 'Davidson', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ryan', 'Roberts', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Dylan', 'Clancy', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Justin', 'Divitto', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Caroline', 'Quinlan', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Dillon', 'Richardson', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Amaury', 'Henroz', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Ellie', 'Ouano', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Landen', 'Jorgensen', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Emma', 'Hopfmann', $denNumber)";
        $result = $dbconn->db_query($sql);
        $sql = "INSERT INTO racer values(0, 'Maggie', 'Hopfmann', $denNumber)";
        $result = $dbconn->db_query($sql);
